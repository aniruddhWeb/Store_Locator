...
import { useProductReviewsBySlugLazyQuery } from '../../generated/graphql';

export const useProductReviewsDynamic = (props: any) => {
  ...
  const [getProduct, { loading: isLoading }] = useProductReviewsBySlugLazyQuery(
    {
